...
<div class="modal-box modal-box_<?=$arParams['PARAM_1']?>">
    ...
    action="<?= (isset($arParams["CURRENT_URL"]) && $arParams["CURRENT_URL"]!="") ? $arParams["CURRENT_URL"] : POST_FORM_ACTION_URI?>" method="post" <?if($arParams['PARAM_1'] == 'one'){?>onsubmit="ym(53077474,'reachGoal','zadat-vopros-ok');return true;"<?}?>
