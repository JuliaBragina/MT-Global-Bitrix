...
<div class="modal-box modal-box_<?=$arParams['PARAM_1']?>">
    ...
    <form class="modal-form <?=$arParams['ACTION_CODE']?> feedback" autocomplete="off" action="<?= (isset($arParams["CURRENT_URL"]) && $arParams["CURRENT_URL"]!="") ? $arParams["CURRENT_URL"] : POST_FORM_ACTION_URI?>" method="post">
        <?=bitrix_sessid_post()?>
