...
?>
<form class="<?=$arParams['ACTION_CODE']?> feedback request-form_three" autocomplete="off"
action="<?=POST_FORM_ACTION_URI?>" method="post">
    ...
    <div class="form-bottom">
        ...
        <button class="form-button ss6" onsubmit="ym(53077474,'reachGoal','send-form');return true;" type="submit"><?=GetMessage("BUTTONrequest_3")?></button>
    </div>
</form>
