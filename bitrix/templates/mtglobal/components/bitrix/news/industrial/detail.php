...
?>
<?
//для решение бага с хлебными крошками, разделил шаблон детального просмотра
...
<section class="section page-navigation">
 <div class="container">
  ...
  <div class="like_h2"><?=$GLOBALS["TITLE_BLOCK_pagination"];?></div>
  <?/*<!--/-->
  <div class="page-navigation_boxs">
   <!---->
   <a href="industrial.html" class="page-navigation_box">
    <span>Офисы</span>
    <span> <svg class="slider-arrow" viewBox="0 0 46 45" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     </svg><b>Предыдущее</b></span>
	   <img src="/img/photo/expertise/1.jpg" alt="photo">
   </a>
   <!---->
   <a href="industrial.html" class="page-navigation_box">
    <span>Складские помещения</span>
    <span><b>Следующее</b><svg class="slider-arrow" viewBox="0 0 46 45" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M22.6289 29L29.6289 22L22.6289 15" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
	   ...
	   <img src="/img/photo/expertise/2.jpg" alt="photo">
   </a>
   <!---->
  </div>
  <!--/-->*/?>
    <?$APPLICATION->IncludeComponent(
        "bitrixsoid:navigation_as_prev_next",
        "",
        Array(
            "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
            "IBLOCK_ID" => $arParams["IBLOCK_ID"],
