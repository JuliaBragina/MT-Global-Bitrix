$(document).ready(function() {
 ...
 gsap.from('.provide-box li', { scrollTrigger: { trigger: '.provide-box' }, opacity: 0, y: 20, stagger: 0.3 });
 gsap.from('.success-box', { scrollTrigger: { trigger: '.success-boxs' }, opacity: 0, x: -30, stagger: 0.3 });
 gsap.from('.licensed-slide', { scrollTrigger: { trigger: '.licensed-slider' }, opacity: 0, stagger: 0.2 });
 ...
 gsap.from('.software-box', { scrollTrigger: { trigger: '.software-boxs' }, opacity: 0, x: -30, stagger: 0.3 });
 gsap.from('.software-bottom', { scrollTrigger: { trigger: '.software-bottom' }, opacity: 0, y: 20 });
 gsap.from('.cost-slide', { scrollTrigger: { trigger: '.cost-slider' }, opacity: 0, stagger: 0.2 });
 ...
 gsap.from('.result-slide', { scrollTrigger: { trigger: '.result-slider' }, opacity: 0, stagger: 0.2 });
