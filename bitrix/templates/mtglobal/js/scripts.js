$(document).ready(function () {
    ...
    $(".btn-modal_eight, .modal-close_eight, .modal-bgr_eight").click(function () {
        $('.modal-box_eight, .modal-bgr_eight').fadeToggle();
    });

    $(".btn-modal_callback, .modal-close_callback, .modal-bgr_callback").click(function () {
        $('.modal-box_callback, .modal-bgr_callback').fadeToggle();
    });
        */
    ///////// html подгружается через ajax, поэтому обработчик таким образом

    $(document).on('click', '.btn-modal_one, .modal-close_one, .modal-bgr_one', function (e) {
        $('.modal-box_one, .modal-bgr_one').fadeToggle();
    });
    $(document).on('click', '.btn-modal_two, .modal-close_two, .modal-bgr_two', function (e) {
        $('.modal-box_two, .modal-bgr_two').fadeToggle();
    });
    $(document).on('click', '.btn-modal_three, .modal-close_three, .modal-bgr_three', function (e) {
        $('.modal-box_three, .modal-bgr_three').fadeToggle();
    });
    $(document).on('click', '.btn-modal_four, .modal-close_four, .modal-bgr_four', function (e) {
        $('.modal-box_four, .modal-bgr_four').fadeToggle();
    });
    $(document).on('click', '.btn-modal_five, .modal-close_five, .modal-bgr_five', function (e) {
        $('.modal-box_five, .modal-bgr_five').fadeToggle();
    });
    $(document).on('click', '.btn-modal_six, .modal-close_six, .modal-bgr_six', function (e) {
        $('.modal-box_six, .modal-bgr_six').fadeToggle();
    });
    $(document).on('click', 'btn-modal_seven, .modal-close_seven, .modal-bgr_seven', function (e) {
        $('.modal-box_seven, .modal-bgr_seven').fadeToggle();
    });
    $(document).on('click', '.btn-modal_eight, .modal-close_eight, .modal-bgr_eight', function (e) {
        $('.modal-box_eight, .modal-bgr_eight').fadeToggle();
    });
    $(document).on('click', '.btn-modal_callback, .modal-close_callback, .modal-bgr_callback ', function (e) {
        $('.modal-box_callback, .modal-bgr_callback').fadeToggle();
    ...
    gsap.to('.process-box', 1, {
        scrollTrigger: {trigger: '.process-boxs_bgr', toggleClass: 'active'},
        opacity: 1,
        stagger: 0.2
    });
    /*info slider*/
    var swiper = new Swiper('.certificatesSlider', {
        ...
        navigation: {
            nextEl: '.certificatesSlider_next',
            prevEl: '.certificatesSlider_prev',
        },
        pagination: {
    ...
    /*licensed slider*/
    var swiper = new Swiper('.licensed-slider-53', {
        loop: false,
        observer: true,
        observeParents: true,
        slidesPerView: 1,
        ...
        pagination: {
            el: '.licensed-pagination-53',
            clickable: true,
        },
        navigation: {
            nextEl: '.licensed-53-arrow_next',
            prevEl: '.licensed-53-arrow_prev',
        },
        breakpoints: {
            1200: {
                slidesPerView: 3,
    ...
    /*licensed slider*/
    var swiper = new Swiper('.licensed-slider-54', {
        loop: false,
        observer: true,
        observeParents: true,
        slidesPerView: 1,
        ...
        pagination: {
            el: '.licensed-pagination-54',
            clickable: true,
        },
        navigation: {
            nextEl: '.licensed-54-arrow_next',
            prevEl: '.licensed-54-arrow_prev',
        },
        breakpoints: {
            1200: {
                slidesPerView: 3,
    ...
    var swiper = new Swiper('.licensed-slider-56', {
        loop: false,
        observer: true,
        observeParents: true,
        slidesPerView: 1,
        ...
        pagination: {
            el: '.licensed-pagination-56',
            clickable: true,
        },
        navigation: {
            nextEl: '.licensed-56-arrow_next',
            prevEl: '.licensed-56-arrow_prev',
        },
        breakpoints: {
            1200: {
                slidesPerView: 3,
    ...
    /*licensed slider*/
    var swiper = new Swiper('.licensed-slider-55', {
        loop: false,
        observer: true,
        observeParents: true,
        slidesPerView: 1,
        ...
        pagination: {
            el: '.licensed-pagination-55',
            clickable: true,
        },
        navigation: {
            nextEl: '.licensed-55-arrow_next',
            prevEl: '.licensed-55-arrow_prev',
        },
        breakpoints: {
            1200: {
                slidesPerView: 3,
    ...
    ;
    var homeSlider = new Swiper('.result-slider', options);
    /*cost slider*/
    ...
    gsap.from('.request-three .section-title h2', {
        scrollTrigger: {trigger: '.request-three .section-title'},
        opacity: 0,
        y: 20
    });
    ...
    /* $('.header-menu_list li a').each(function(){
      var link = this.href;

      if(link == window.location.href){
        console.log();
        $(this).addClass('active_ssil');
      }
    });  */

    //ajax запрос на формы
    $.ajax({
        url: '/ajax/modal_forms.php',         /* Куда отправить запрос */
        ...
        success: function(data){   /* функция которая будет выполнена после успешного запроса.  */
            ...
            console.log("pixelplus before captcha");
                if (typeof(grecaptcha) == 'undefined') {
                    var grecaptcha_s = document.createElement('script');
                    grecaptcha_s.src = 'https://www.google.com/recaptcha/api.js?render='+UF_KEY_RECATCHA+'&onload=googleCaptcha';
            ...
            if ( typeof googleCaptcha == 'undefined' ) {
                var googleCaptcha = () => {
                    grecaptcha.execute(UF_KEY_RECATCHA,{action: 'feedback'}).then(
                        function(token) {
            ...
            console.log("pixelplus after captcha");
...
$(function ($) {
    ...
    $.each($('.header-menu_list a'), function (index, value) {
...
$(document).ready(function () {
    ...
    if (url.indexOf('https://mtglobal.ru/specialization/sistemy-bezopasnosti-it-infrastruktury/') != -1) {
        let cont = "Кроме аудита безопасности  мы ИТ-инфраструктуры квалифицированно оказываем услуги:";
        $(".h--box").append(cont);
        let cont2 = "<div class='h--form'>Оставить заявку на консультацию по стоимости аудита ИТ-безопасности</div>";
        $(".h--preform").append(cont2);
    }

    if (url.indexOf('https://mtglobal.ru/specialization/apparatnaya-infrastruktura/') != -1) {
        let cont = "Для комплексного обслуживания аппаратной инфраструктуры мы квалифицированно оказываем услуги:";
        $(".h--box").append(cont);
        let cont2 = "<div class='h--form'>Оставить заявку на консультацию по стоимости обслуживания аппаратной инфраструктуры</div>";
        $(".h--preform").append(cont2);
    }

    if (url.indexOf('https://mtglobal.ru/specialization/nastrojka-setevoj-infrastruktury/') != -1) {
        let cont = "Для комплексного обслуживания и настройки аппаратного обеспечения сетевой инфраструктуры мы оказываем услуги:";
        $(".h--box").append(cont);

        let cont2 = "<div class='like_h2 request__title--h2'>Узнать стоимость обслуживания сетевой инфраструктуры</div>";
        $(".h--preform").append(cont2);
    }

    if (url.indexOf('https://mtglobal.ru/industrial/it-infrastruktura-magazinov/') != -1) {
        $(".swiper-slide p.descr-s").eq(10).wrap('<a class="sw-slider" href="/solution/modernizatsiya-it-infrastruktury/"></a>');
    }


    if (url.indexOf('https://mtglobal.ru/industrial/it-infrastruktura-skladskih-pomeshchenij/') != -1) {
        $(".swiper-slide p.descr-sm").eq(5).replaceWith("<p class='descr-sm'>Повышение эффективности  бизнеса через <a style='color: white;' class='sw-slider' href='/service/it-autsorsing-obsluzhivanie-it-infrastruktury/'>оптимизацию ИТ-инфраструктуры</a></p>");
    }


    if (url.indexOf('https://mtglobal.ru/industrial/it-infrastruktura-promyshlinnosti-selskogo-hozyajstva/') != -1) {
        $(".software-box p.descr-s").eq(4).replaceWith("<p class='descr-s'>Подключение и настройка <a style='text-decoration:underline;' onMouseOver=\"this.style.color='#2140e5'\" href='/specialization/apparatnaya-infrastruktura/'>аппаратной инфраструктуры</a></p>");
    }


    if (url.indexOf('https://mtglobal.ru/specialization/servera-i-sistemy-khraneniya-dannykh/') != -1) {
        let cont = "<div class='h--form'>Оставить заявку на консультацию по стоимости проекта обслуживания серверов и систем хранения данных</div>";
        $(".h--preform").append(cont);
    }

    if (url.indexOf('https://mtglobal.ru/specialization/obsluzhivanie-programmnogo-obespecheniya/') != -1) {
        let cont = "Для комплексного обслуживания и настройки аппаратного обеспечения сетевой инфраструктуры мы оказываем услуги:";
        $(".h--box").append(cont);
        let cont2 = "<div class='like_h2 request__title--h2'>Узнать стоимость обслуживания ПО</div>";
        $(".h--preform").append(cont2);
    }
