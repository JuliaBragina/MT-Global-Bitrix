...
<section class="home">
 ...
 <div class="container">
  <div class="home-bottom">
   <h3><?$APPLICATION->IncludeFile('/include/main/home-bottom.php',Array(),Array('MODE'=>'html'));?></h3>
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "main_home-bottom"
	),
	false
);?>
  </div>
...
<!--/request-->
<!--services-->
<?$TITLE_BLOCK_service = "Our service";?>
...
<!--/services-->
<!--complex-->
<?$TITLE_BLOCK_solution = "Complex solutions";?>
 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"anons_solution",
	array(
...
<?$TITLE_BLOCK_industrial = "Industrial solutions";?>
...
<!--specializations-->
<?$TITLE_BLOCK_specialization = "Our specialization";?>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FIELDS" => "[{\"code\":\"name\",\"name\":\"Name\",\"is_required\":\"Y\",\"tag\":\"input\",\"input_type\":\"tel\"}]",
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"TITLE_BLOCK_info" => "Why else do customers choose us:"
	),
	false
);?>2
</section>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FIELDS" => "[{\"code\":\"email\",\"name\":\"Email\",\"is_required\":\"N\",\"tag\":\"input\",\"input_type\":\"email\"},{\"code\":\"phone\",\"name\":\"Phone\",\"is_required\":\"Y\",\"tag\":\"input\",\"input_type\":\"tel\"},{\"code\":\"message\",\"name\":\"Message\",\"is_required\":\"N\",\"tag\":\"input\",\"input_type\":\"text\"}]",
