...
$APPLICATION->SetPageProperty("title", "Условия использования - Правила и положения MTGlobal");
$APPLICATION->SetPageProperty("description", "Ознакомьтесь с правилами и условиями использования услуг и продуктов MTGlobal для безопасной и эффективной работы.");
...
<div class="terms-of-use">
	...
	<section class="terms-of-use__section">
		<div class="container">
	...
	<section class="terms-of-use__section">
		<div class="container">
			<div class="section-title">
				<h2 class="section-title__blue">Политика в отношении обработки персональных данных</h2>
			</div>
		</div>
	</section>
	...
	<section class="terms-of-use__section">
		<div class="container">
			<div class="section-title section-hr mb30 pb30">
				<h2>1. Общие положения</h2>
				<div class="poc-subtitle">
					<p>
						...
						персональных данных, предпринимаемые ООО «Медиа Технологии» (далее – Оператор).
					</p>
			...
			<div class="section-title section-hr mb30 pb30">
				...
				<div class="poc-subtitle">
					...
					<p>2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или
						определяемому Пользователю веб-сайта https://mtglobal.ru/. </p>
					...
					<p>2.10. Пользователь – любой посетитель веб-сайта https://mtglobal.ru/. </p>
					...
					<p>2.12. Распространение персональных данных – любые действия, направленные на раскрытие
						...
						в средствах массовой информации, размещение в информационнотелекоммуникационных сетях или
	...
	<!-- 3 -->
	<section class="terms-of-use__section pb30">
		<div class="container">
			<div class="section-title section-hr">
