...
<section id="ourApproach" class="ourApproach section">
    ...
    <div class="ourApproach__container container">
        ...
        <button type="button" class="btn btn-primary btn-arrow-white popup__callBack ourApproach__button" data-fancybox href="#popup__callBack"  data-options='{"touch" : false, "momentum" : false}'>Подобрать решение</button>
    </div>
</section>
