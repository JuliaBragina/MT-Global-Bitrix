...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<section class="main__section checkout">
		<div class="main__container">
			<h2 class="main__heading"><?=$APPLICATION->ShowTitle();?></h2>
	...
	<form class="checkout-form" id='basket-axpro'>
	<fieldset class="checkout-form__fieldset checkout-form__fieldset_top">
	  <label class="checkout-form__label-input">
		<input type='hidden' name='formAction' value='addOrder'/>
		<span>Ваше имя</span><input  name='name' type="text" placeholder="Имя" required/>
	  </label>

	  <label class="checkout-form__label-input">
		<span>Номер телефона</span>
		<input type="tel" name='phone' id='phone-basket' placeholder="+7 (900) 800-00-00" required />
	  </label>
		
	  <label class="checkout-form__label-textarea">
		<span>Комментарий</span>
		  <textarea name='comment' placeholder="Введите комментарий" rows="4" style='color:black'></textarea>
	  </label>
	</fieldset>

	<fieldset
	  class="checkout-form__fieldset checkout-form__fieldset_bottom"
	>
	  <label class="checkout-form__label-checkbox">
		<input type="checkbox" checked required />
		<span>Согласие на обработку персональных данных</span>
	  </label>
	  <button class="button button_large">Оформить заказ</button>
	</fieldset>
  </form>
	<?
